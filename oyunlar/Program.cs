...
do
{
    string secimEkrani = $"1) Sayı Tanmin Oyunu\n2) Zar Tahmin Oyunu\n3) Sayıyı Metne Çevir\n4) Çıkış\n3) Sayıyı Metne Çevir\n4) Çıkış";
    ...
    do
    {
        ...
        try
        {
            ...
            if (tahminEdilenSayi < 0 || tahminEdilenSayi > 100)
                throw new Exception("0-100 arasında sayı giriniz");
...
void ZarTahminOyunu()
{
    ...
    int tahminSayisi = 0, girilenSayi = SayiGirdirici(1, 6, "1-6 arasında sayı giriniz");
...
void SayiyiMetneÇevir()
{
    Console.Clear();
    Console.WriteLine("sayıyı metne çevir oyunu başlıyor");
